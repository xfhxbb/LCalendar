...
class MobileCalendar {
  ...
  defaultValueInit() {
    ...
    if (/^\d{4}-\d{1,2}-\d{1,2}\s\d{2}:\d{2}$/.test(this.trigger.value)) {
      let rs = this.trigger.value.match(/(^|-|\s|:)\d{1,4}/g);
    ...
    //初始化年月日插件默认值
      ...
      let rs = this.trigger.value.match(/(^|-)\d{1,4}/g);
      dateArr.yy = rs[0] - this.minY;
      dateArr.mm = rs[1].replace(/-/g, "") - 1;
      dateArr.dd = rs[2].replace(/-/g, "") - 1;
    }
    ...
    //初始化时分插件默认值
      ...
      let rs = this.trigger.value.match(/(^|:)\d{2}/g);
      dateArr.hh = parseInt(rs[0].replace(/^0?/g, ""));
      dateArr.mi = parseInt(rs[1].replace(/:0?/g, ""));
    } else {
  ...
  setDateGearTooth() {
    ...
    top = Math.floor(parseFloat(date_mm.getAttribute("top")));
    if (!isNaN(top)) {
      if (mmVal > maxM) {
        mmVal = maxM;
      } else if (mmVal < minM) {
...
/* harmony default export */ __webpack_exports__["default"] = (MobileCalendar);
...
/***/ 0:
/*!************************************!*\
  !*** multi ../src/js/LCalendar.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\git\LCalendar\src\js\LCalendar.js */"../src/js/LCalendar.js");


/***/ })

/******/ });
//# sourceMappingURL=LCalendar.js.map